...
if (!isset($_SESSION['logged_in'])) {
    header('location: public_html/loginpengguna.php');
    exit;
}

require_once 'public_html/iot/bacadatauser.php';

// Tentukan path ke file yang ingin Anda baca
$folder_path = "public_html/iot/bacadatauser.php";
...
// Koneksi ke database
include 'public_html/db_config.php';
